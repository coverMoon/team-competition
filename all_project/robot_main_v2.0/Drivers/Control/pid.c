...
void Pid_parameter_init(void){
	Pid_increment_struct_init(&motor_pid_g[0].loc,  0.15, 	0.001,	0.035,   500,    -500);
	Pid_increment_struct_init(&motor_pid_g[0].spd,  24.0, 	1.2,	  0.03,  12000,  -12000);
	
	Pid_increment_struct_init(&motor_pid_g[1].loc,  0.15, 	0.001,	0.035,   500,    -500);
	Pid_increment_struct_init(&motor_pid_g[1].spd,  24.0, 	1.2,	  0.03,  12000,  -12000);
	
	Pid_increment_struct_init(&motor_pid_g[2].loc,  0.15, 	0.001,	0.035,   500,    -500);
	Pid_increment_struct_init(&motor_pid_g[2].spd,  24.0, 	1.2,	  0.03,  9500,  -9500);
	
	Pid_increment_struct_init(&motor_pid_g[3].loc,  0.15, 	0.001,	0.035,   500,    -500);
	Pid_increment_struct_init(&motor_pid_g[3].spd,  24.0, 	1.2,	  0.03,  9500,  -9500);
	
	Pid_increment_struct_init(&motor_pid_g[4].loc,  0.15, 	0.001,	0.03,   500,    -500);
	Pid_increment_struct_init(&motor_pid_g[4].spd,  24.0, 	1.2,	  0.035,   9500,  -9500);
	
	Pid_increment_struct_init(&motor_pid_g[5].loc,  0.15, 	0.001,	0.03,  500,    -500);
	Pid_increment_struct_init(&motor_pid_g[5].spd,  24.0, 	1.2,	  0.035,   9500,  -9500);
	
	Pid_increment_struct_init(&motor_pid_g[6].loc,  0.15, 	0.001,	0.03,  500,    -500);
